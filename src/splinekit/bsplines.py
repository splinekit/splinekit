...
def spline_polynomial (
    *,
    ...
    B-spline-weighted sums of discrete canonic monomials can be computed for
    positive :ref:`odd<def-odd>` monomial degree :math:`m` as
    ...
    while B-spline-weighted sums of discrete canonic monomials can be computed
    for positive :ref:`even<def-even>` monomial degree :math:`m` as
